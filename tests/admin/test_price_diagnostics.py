...
def _sample_prices(*, valid_from: str = "2026-01-01") -> dict:
    return {
        "_meta": {"valid_from": valid_from},
        "models": {
...
def test_diagnose_prices_marks_valid_from_in_past_as_expired() -> None:
    old_prices = _sample_prices(valid_from="2026-01-01")
    fresh_prices = _sample_prices(valid_from="2026-06-12")
