...
# Есть в PDF (редкие модели), в prices.json пока нет — PDF источник правды:
EXPECTED_NEW = {
    "vesta-фл-60-12", "vesta-фл-60-16",
    "vesta-сл-60-12", "vesta-сл-60-16",
    "vesta-сл-100-18", "vesta-сл-100-20", "vesta-сл-100-22", "vesta-сл-100-24",
    "vesta-ф-60-12", "vesta-ф-60-16",
    "vesta-с-60-12", "vesta-с-60-16",
}
