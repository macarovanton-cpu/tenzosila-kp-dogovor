...
MOCK_DATA = {
    ...
    "СПЕЦ_НОМЕР": "1",
    "СПЕЦ_НДС": "22",
    # Full-формат (нумерация «2.N») — иначе страж A5 в fill_spec_v2 отклонит
    # fallback-путь _payment_lines_from_data как КП-lite.
    "СПЕЦ_ОПЛАТА_П1": "2.1. Предоплата 30% в размере 600 000 рублей, в т.ч. НДС 22%.",
    "СПЕЦ_ОПЛАТА_П2": "2.2. Оплата по отгрузке 70% в размере 1 400 000 рублей, в т.ч. НДС 22%.",
    "СПЕЦ_ОПЛАТА_П3": "",
    "СПЕЦ_ОПЛАТА_П4": "",
    "СПЕЦ_ОПЛАТА_П5": "",
    "СПЕЦ_ОПЛАТА_П6": "",
