...
Текущая фаза: 2.x — закрытие багов, готовность к Промту C и деплою
...
### Шаг 10 — Прогон синтетики + тег v0.8 (~15 мин) ← ТЕКУЩИЙ
- test_e2e_synthetic.py — зафиксировать текущее состояние
- findings: «Сессия 4»
- Тег v0.8
